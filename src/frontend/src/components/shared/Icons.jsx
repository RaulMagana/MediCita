...
export const Icons = {
  Home: (props) => (
    <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 12l2.146-2.854A1 1 0 015.146 8H7V5a1 1 0 011-1h8a1 1 0 011 1v3h1.854a1 1 0 01.854.146L21 12M5 20h14a2 2 0 002-2V9" />
    </svg>
  ),

  Users: (props) => (
    <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 4.354a4 4 0 110 8.048M3 20.5h18" />
    </svg>
  ),
  ...
  Spinner: (props) => (
    <svg {...props} fill="none" viewBox="0 0 24 24" animate-spin>
